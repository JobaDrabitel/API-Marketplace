...
app.MapGet("/api/product/delete/{Id}", async (MarketplaceDbContext dbContext, HttpContext context) =>
	await APIHandler.HideProduct(context, dbContext));

app.MapPost("/api/product/getbyfields", async (MarketplaceDbContext dbContext, HttpContext context) =>
...
app.MapPost("/api/review/getbyfields", async (MarketplaceDbContext dbContext, HttpContext context) =>
...
app.MapDelete("/api/category/deletebyid/{Id}", async (MarketplaceDbContext dbContext, HttpContext context) =>
...
app.MapGet("/api/category/getbyid/{Id}", async (MarketplaceDbContext dbContext, HttpContext context) =>
...
app.MapGet("/api/wishlist/getbyid/{Id}", async (MarketplaceDbContext dbContext, HttpContext context) =>
...
app.MapDelete("/api/wishlist/deletebyid/{Id}", async (MarketplaceDbContext dbContext, HttpContext context) =>
...
app.MapPost("/api/wishlist/getbyfields", async (MarketplaceDbContext dbContext, HttpContext context) =>
...
app.MapDelete("/api/role/deletebyid/{Id}", async (MarketplaceDbContext dbContext, HttpContext context) =>
...
app.MapGet("/api/role/getbyid/{Id}", async (MarketplaceDbContext dbContext, HttpContext context) =>
