...
// Products
app.MapPut("/api/product/create", async (MarketplaceContext dbContext, HttpContext context) =>
...
app.MapGet("/api/product/getbyuser/{Id}", async (MarketplaceContext dbContext, HttpContext context) =>
    await APIHandler.GetProductsOfUser(context, dbContext));
